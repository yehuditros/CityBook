...
namespace WeatherForecast
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<Dal.Models.WeatherForecatDBContext>(options => options.UseSqlServer("Server=DESKTOP\\YEHUDIT;Database=WeatherForecatDB;User ID=DESKTOP\\User; Password=YRyr2066;Initial Catalog=WeatherForecatDB; Integrated Security=True;"));
